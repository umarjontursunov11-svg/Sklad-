...
export const translations = {
  uz: {
    ...
    invoices: 'Yuk Xatlari & Fakturalar',
    ...
    manufactureDate: 'Ishlab chiqarilgan sana',
    expiryDate: 'Yaroqlilik muddati',
    storageConditions: 'Saqlash sharoiti',
    expiringSoonBadge: 'Muddati oz qolgan (≤3 oy)',
    expiredBadge: 'Muddati o\'tgan',
    expiryStatusGood: 'Yaroqli',
    filterAllProducts: 'Barchasi',
    filterExpiringProducts: 'Muddati oz qolgan (≤3 oy)',
    daysLeft: 'kun qoldi',
    daysExpired: 'kun o\'tib ketgan',
    storagePresetRefrigerated: '+2°C...+8°C (Muzlatgich/Sovutgich)',
    storagePresetRoom: '15°C-25°C (Xona harorati)',
    storagePresetDryDark: 'Quruq va qorong\'i joyda',
    storagePresetKeepDry: 'Namlikdan saqlansin',
    expiringStockWarning: 'Yaroqlilik muddati oz qolgan tovarlar',
    expiringCount: 'ta muddati oz qolgan tovar',
    tabAllNotifications: 'Barchasi',
    tabLowStock: 'Kam qolgan',
    tabExpiringStock: 'Muddati oz qolgan',

    // Staff & Roles
    roleReceiver: 'Qabul qiluvchi (Receiver)',
    roleDispatcher: "Jo'natuvchi (Dispatcher)",
    roleManager: 'Ombor Mudiri (Manager)',
    roleAdmin: 'Tizim Administratori',
    employeeId: 'Xodim kodi',
    auditLogs: 'Audit Jurnali',
    correctionRequests: "Tuzatish So'rovlari",
    submitCorrection: "Tuzatish so'rash",
    reasonForCorrection: 'Tuzatish sababi',
    requestedQty: "To'g'ri miqdor",
    correctionSubmitted: "Tuzatish so'rovi muvaffaqiyatli yuborildi",
    approveCorrection: 'Tasdiqlash',
    rejectCorrection: 'Rad etish',
    adminPinModalTitle: 'Admin Xavfsizlik Tekshiruvi',
    adminPinDesc: "Admin bo'limiga kirish uchun maxfiy parol talab etiladi.",
    enterPinPlaceholder: 'Admin parolini kiriting...',
    verifyPinBtn: 'Kodni Tasdiqlash',
    invalidPin: "Parol noto'g'ri! Urinish xavfsizlik jurnaliga qayd etildi.",
    accessDenied: 'Ruxsat berilmagan (Faqat Administrator)',
  },
  ...
  ru: {
    ...
    expiringSoonBadge: 'Истекает срок (≤3 мес)',
    expiredBadge: 'Просрочен',
    expiryStatusGood: 'Годен',
    filterAllProducts: 'Все товары',
    filterExpiringProducts: 'Истекает срок (≤3 мес)',
    daysLeft: 'дн. осталось',
    daysExpired: 'дн. назад истек',
    storagePresetRefrigerated: '+2°C...+8°C (Холодильник)',
    storagePresetRoom: '15°C-25°C (Комнатная темп.)',
    storagePresetDryDark: 'В сухом темном месте',
    storagePresetKeepDry: 'Беречь от влаги',
    expiringStockWarning: 'Товары с истекающим сроком годности',
    expiringCount: 'тов. с истекающим сроком',
    tabAllNotifications: 'Все',
    tabLowStock: 'Мало на складе',
    tabExpiringStock: 'Истекает срок',

    // Staff & Roles
    roleReceiver: 'Приемщик (Receiver)',
    roleDispatcher: 'Экспедитор / Отгрузчик (Dispatcher)',
    roleManager: 'Заведующий складом (Manager)',
    roleAdmin: 'Системный администратор',
    employeeId: 'Код сотрудника',
    auditLogs: 'Журнал аудита',
    correctionRequests: 'Запросы на корректировку',
    submitCorrection: 'Запросить корректировку',
    reasonForCorrection: 'Причина корректировки',
    requestedQty: 'Скорректированное кол-во',
    correctionSubmitted: 'Запрос на корректировку успешно отправлен на рассмотрение',
    approveCorrection: 'Утвердить',
    rejectCorrection: 'Отклонить',
    adminPinModalTitle: 'Проверка прав администратора',
    adminPinDesc: 'Для доступа к панели администратора требуется секретный пароль.',
    enterPinPlaceholder: 'Введите пароль администратора...',
    verifyPinBtn: 'Подтвердить',
    invalidPin: 'Неверный пароль! Попытка зафиксирована в журнале безопасности.',
    accessDenied: 'Доступ ограничен (Только Администратор)',
  },
  ...
  en: {
    ...
    expiringSoonBadge: 'Expiring Soon (≤3 mos)',
    expiredBadge: 'Expired',
    expiryStatusGood: 'Valid',
    filterAllProducts: 'All Products',
    filterExpiringProducts: 'Expiring Soon (≤3 mos)',
    daysLeft: 'days left',
    daysExpired: 'days expired',
    storagePresetRefrigerated: '+2°C...+8°C (Refrigerated)',
    storagePresetRoom: '15°C-25°C (Room Temp)',
    storagePresetDryDark: 'Dry and dark place',
    storagePresetKeepDry: 'Keep dry / Protect from moisture',
    expiringStockWarning: 'Expiring Stock Items',
    expiringCount: 'item(s) expiring soon',
    tabAllNotifications: 'All',
    tabLowStock: 'Low Stock',
    tabExpiringStock: 'Expiring Soon',

    // Staff & Roles
    roleReceiver: 'Receiver (Qabul qiluvchi)',
    roleDispatcher: 'Dispatcher (Jo\'natuvchi)',
    roleManager: 'Warehouse Manager',
    roleAdmin: 'System Administrator',
    employeeId: 'Staff ID',
    auditLogs: 'Audit Log',
    correctionRequests: 'Correction Requests',
    submitCorrection: 'Request Correction',
    reasonForCorrection: 'Reason for correction',
    requestedQty: 'Corrected quantity',
    correctionSubmitted: 'Correction request submitted for manager review',
    approveCorrection: 'Approve',
    rejectCorrection: 'Reject',
    adminPinModalTitle: 'Admin Security Verification',
    adminPinDesc: 'Secret password required to access admin control center.',
    enterPinPlaceholder: 'Enter admin password...',
    verifyPinBtn: 'Verify Password',
    invalidPin: 'Invalid password! Attempt logged in security audit.',
    accessDenied: 'Access Denied (Administrator Only)',
  },
};
