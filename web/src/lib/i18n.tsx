...
export const translations = {
  uz: {
    ...
    adminPinDesc: "Admin bo'limiga kirish uchun Master PIN kod talab etiladi.",
    enterPinPlaceholder: 'Master PIN (9876)',
    verifyPinBtn: 'Kodni Tasdiqlash',
    invalidPin: "PIN kod noto'g'ri! Urinish xavfsizlik jurnaliga qayd etildi.",
  ...
  ru: {
    ...
    adminPinDesc: 'Для доступа к панели администратора требуется мастер PIN-код.',
    enterPinPlaceholder: 'Мастер PIN (9876)',
    verifyPinBtn: 'Подтвердить код',
    invalidPin: 'Неверный PIN-код! Попытка зафиксирована в журнале безопасности.',
  ...
  en: {
    ...
    adminPinDesc: 'Master PIN required to access admin control center.',
    enterPinPlaceholder: 'Master PIN (9876)',
    verifyPinBtn: 'Verify Code',
    invalidPin: 'Invalid PIN code! Attempt logged in security audit.',
