...
export const translations = {
  ...
  ru: {
    ...
    gridLayout: 'Разметка:',
    columns2: '2 колонки (Крупный)',
    columns3: '3 колонки (Лист А4)',
    browserPrint: 'Печать через браузер',
    downloadPdfSheet: 'Скачать PDF лист',
  ...
  en: {
    ...
    columns2: '2 Columns (Large)',
    columns3: '3 Columns (Standard A4)',
    browserPrint: 'Browser Print',
    downloadPdfSheet: 'Download PDF Sheet',
